...
$skins = aloha_get_predefined_param('skins', array("default" => t("Default Style")));
...
$layouts = aloha_get_predefined_param('layout', array("layout-default" => t("Default Layout")));
...
foreach ($layouts as $layout => $layout_title) {
  ...
  if ($layout == 'default' && empty($current_layout)) {
    $label_class = 'active';
  }
